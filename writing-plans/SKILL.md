...
**Save plans to:** `docs/features/YYYY-MM-DD-<feature-name>/plans.md`
...
- "Verify UI/UX in the browser against the design (for UI tasks)" - step
...
- [ ] All copy/labels match
- [ ] Empty state renders correctly
- [ ] Loading state renders correctly
- [ ] Error state renders correctly
- [ ] Interactions (hover, click, focus) behave as designed
...
**"Plan complete and saved to `docs/plans/YYYY-MM-DD-<feature-name>/plan.md`. Two execution options:**
